 ...
 * @version 1.6 - Android entegrasyonu tamamlandı ve PID menü düzenlemeleri eklendi
 */
...
String WiFiManager::_getHtmlContent() {
    // Geliştirilmiş HTML: Android uygulama kontrollerini destekler ve PID seçenekleri güncellendi
...
<option value='2'>Otomatik Ayar</option>
</select>
